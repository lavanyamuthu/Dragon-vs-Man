...
{ 
  /*std::cout << "gamedata display" << std::endl;
  std::map<string, string>::const_iterator ptr1 = gameData.begin();
  while ( ptr1 != gameData.end()) {
    std::cout << ptr1->first << ", " << ptr1->second << std::endl;
  }*/
}
